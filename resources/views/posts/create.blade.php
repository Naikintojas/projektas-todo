                          ...
                          <form action="/posts" method="POST">
                            {{ csrf_field() }}
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control py-4" id="title" placeholder="Enter fullname" name="title">
                              </div>
                              <div class="form-group"> 
                                <label class=" mb-1" for="inputProjectname">Description</label>
                                <textarea class="form-control" id="aprasymas" rows="2" placeholder="Tell us more about this poll" name="aprasymas"></textarea>
                              </div>
                              <div class="form-group"> 
                              ...
                              <div class="form-group"> 
                                ...
                                <textarea class="form-control" id="extra" placeholder="Tell us more about this poll" name="extra" rows="2"></textarea>
                              </div>
